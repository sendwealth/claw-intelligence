...
# OpenSpark 智能科技 - 通用部署脚本（无系统检测）
# 适用于所有 Linux 发行版

set -e

echo "========================================="
echo "  OpenSpark 智能科技 - 部署开始"
echo "========================================="
echo ""
...
if id nginx &>/dev/null; then
    ...
    chown -R www-data:www-data /var/www/openspark
else
    chown -R root:root /var/www/openspark
fi
...
# 测试 Nginx 配置
echo "🧪 测试 Nginx 配置..."
nginx -t 2>&1 || echo "⚠️  配置测试可能有警告，但可能不影响使用"
echo ""
