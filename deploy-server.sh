...
if command -v nginx &> /dev/null; then
    echo "✅ Nginx 已安装: $(nginx -v 2>&1 | cut -d'/' -f2)"
else
    echo "📦 安装 Nginx..."
...
# 设置权限
echo "🔒 设置权限..."
chown -R nginx:nginx /var/www/openspark 2>/dev/null || chown -R www-data:www-data /var/www/openspark
